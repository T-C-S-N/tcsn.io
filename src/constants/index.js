...
export const EARTH = Object.freeze({
   ...
   ROTATE_CENTER_X: .5, // Center of rotation (0-1 range)
   ROTATE_CENTER_Y: -.1, // Center of rotation (0-1 range) - moved to center
...
export const STARS = Object.freeze({
   MAX_AMOUNT: Math.max(300, Math.min(100, Math.floor(60 * EARTH.ZOOM))), // Cap at 400 stars max for performance
...
export const FLYING_STARS = Object.freeze({
   MIN_SIZE: 0.5,
   MAX_SIZE: 1,
   MIN_VELOCITY: .05, // Reduced for longer duration
...
export const CLUSTER_STARS = Object.freeze({
   ...
   MIN_VELOCITY: .05, // Reduced for longer duration
   MAX_VELOCITY: .2, // Reduced for longer duration
   CLUSTER_RADIUS: 2, // Radius for cluster stars
