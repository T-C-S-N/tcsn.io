<template>
  <!-- Trigger -->
  <div
    class="fixed bottom-[50px] right-[20px] flex justify-center items-center z-[200] border border-primary-100/10 rounded-full backdrop-blur-[2px] text-primary w-[50px] h-[50px] cursor-pointer shadow-lg shadow-primary hover:shadow-primary-300 shadow-inner transition-all"
    ...
    <div class="border-t border-primary/20 p-4 bg-background/80">
      <div class="flex items-center gap-3">
        ...
        <input
          ...
          class="flex-1 bg-primary/5 rounded-lg px-3 py-2 border border-primary/20 font-mono text-sm text-primary placeholder-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50"
          autocomplete="off"
          spellcheck="false"
          :disabled="isLoading"
