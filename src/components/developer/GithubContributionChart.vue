<template>
  <div class="flex flex-col gap-4">
    ...
    <div
      ref="chartContainer"
      class="w-full h-80 bg-gray-900/30 rounded-lg p-4 border border-gray-800"
    />
...
const renderChart = () => {
  ...
  gradient.append('stop').attr('offset', '0%').attr('stop-color', '#ffb679').attr('stop-opacity', 0.3)

  gradient.append('stop').attr('offset', '100%').attr('stop-color', '#ffb679').attr('stop-opacity', 0)
