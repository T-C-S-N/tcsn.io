<template>
  <div class="text-primary w-full">
    ...
    <div
      v-if="isInfoOpen"
      class="flex flex-col gap-4 w-screen h-screen p-4 rounded-b-lg fixed top-0 left-0 z-[200] overflow-y-auto max-h-[100vh] backdrop-blur-[5px] shadow-lg"
    >
...
import VisitorAnalytics from '@/components/VisitorAnalytics.vue'
