...
export default function HeaderLogo({ color }: { color: string }) {
  switch (color) {
    case "white":
      return (
        <div className='w-[100%] flex justify-center items-center'>
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1366 768" className='w-[100%] [&>*]:stroke-white [&>*]:stroke-[6px] [&>*]:fill-none'>
    ...
    case "black":
      return (
        <div className='w-[100%] flex justify-center items-center'>
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1366 768" className='w-[100%] [&>*]:stroke-black [&>*]:stroke-[6px] [&>*]:fill-none'>
            <polygon points="384.2,352.8 580.5,549.2 635.7,604.5 649.2,537.4 397.6,286 	" />
            <polygon points="384.2,352.8 397.6,286 649.2,537.4 397.6,285.8 	" />
            <polygon points="535.6,262.3 415.6,195.7 397.6,285.8 490,270 	" />
            <polygon points="397.6,285.8 7,352.8 384.2,352.8 	" />
